...
@Composable
fun RemovedParamsScreen(
    items: List<RemovedParamUsageItem>,
    onBackClick: () -> Unit,
) {
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(stringResource(R.string.screen_removed_params_title)) },
                navigationIcon = {
        ...
        if (items.isEmpty()) {
            Column(
                ...
                Text(
                    text = stringResource(R.string.screen_removed_params_empty),
